...
os.system('espeak -a 300 " Welcome,   to,  NK,  Gamer,  Tools"')



os.system('espeak -a 300 " Contact ,   My,  TELEGRAM,  I  D,  @nkniloy1117"')
#LOGO
def banner():
	print("""%s
...
#MENU
def menu():
	os.system('xdg-open https://t.me/NKNILOY')
